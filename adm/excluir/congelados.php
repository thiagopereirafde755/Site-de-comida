...
if ($search != '') {
    $sql = "SELECT * FROM congelados WHERE nome LIKE '%$search%'";
} else {
    $sql = "SELECT * FROM congelados";
}
...
<head>
    ...
    <title>Dados de Congelados</title>
...
color: #000000;
    ...
    <br><br>
    <h2 style="text-align: center; justify-content: center;">Dados da Tabela de congelados</h2>
    <br>
    <table border="1">
        <thead>
            <tr>
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>
                            ...
                            <td>
                                ...
                                <a href='deletar/deletar-congelados.php?id=" . $row["id"] . "'>
    ...
    <div class="modal-content">
        ...
        <h2>Atualizar congelados</h2>
        <form id="updateForm" action="atualizar/atualizar-congelado.php" method="POST">
