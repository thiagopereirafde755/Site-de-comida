...
<body>
    ...
    <div class="h11">
        <h1 style="color: rgb(117, 19, 19);">
            SALGADOS <span style="color: rgb(16, 192, 0);">CONGELADOS</span>
        </h1>
    </div>
    ...
    // Consulta para selecionar todos os produtos da tabela congelados
    $sql = "SELECT * FROM congelados";
    $result = $conexao->query($sql);

    // Verifica se há produtos e exibe cada um deles
    ...
    <script src="../js/congelado1.js"></script>
</body>
</html>
